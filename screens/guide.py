...
def render() -> None:
    ...
    st.markdown(
        ...
        "periods alongside the benchmark's drawdown for direct comparison. "
        "Correlations tend to spike toward 1.0 during market stress — "
    ...
    st.markdown(
        ...
        "is a forward-looking estimate that weights recent market moves more heavily and "
        "models how volatility clusters and mean-reverts over time. On short windows (1Y), "
        "the app falls back to EWMA conditional vol — shown as a purple line on the chart "
        "to distinguish it from the blue GARCH trace on longer windows. "
        "The Monte Carlo fan shows the spread of 1,000 simulated portfolio paths — "
        "it is a range of possibilities, not a forecast. "
        "The Signal-Based Sensitivity Analysis shows estimated portfolio losses under three "
        "stress scenarios using **Filtered Historical Simulation**: the actual empirical 5th-percentile "
        "daily return is scaled by the ratio of stressed volatility to historical daily vol. "
        "This preserves your portfolio's real fat-tail and skew properties without assuming "
        "a normal distribution. Toggle between 1-Day and 1-Month VaR; multiply the daily "
        "estimate by √21 ≈ 4.6 for a monthly approximation. "
